...
middle_right_leg = Leg(middle_right_hip_joint, middle_right_knee_joint, middle_right_ankle_joint, LegConfig(mount_angle=45, position=Legs.MIDDLE_RIGHT, hip_trim_angle=-5))
