...
rear_left_leg = Leg(rear_left_hip_joint, rear_left_knee_joint, rear_left_ankle_joint, LegConfig(mount_angle=45, position=Legs.REAR_LEFT, inverse_hip=True, hip_trim_angle=5))
