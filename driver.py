...
middle_left_leg = Leg(middle_left_hip_joint, middle_left_knee_joint, middle_left_ankle_joint, LegConfig(mount_angle=45, position=Legs.MIDDLE_LEFT, inverse_hip=True, hip_trim_angle=3))
